...
| Keys       | Action                                       |
|------------+----------------------------------------------|
| C-arrows   | Move to adjacent window in some direction    |
...
#+begin_src emacs-lisp
  ...
  (defun ig/markdown-paste-image-from-clipboard-advice (orig-func args)
    (let* ((buffer-file-name (if buffer-file-name buffer-file-name "/tmp/tmp"))
           (current-folder (file-name-directory buffer-file-name))
  ...
  (defun ig/markdown-paste-image-advice-helper (orig-func &rest args)
    (if ig/markdown-paste-images
        (ig/markdown-paste-image-from-clipboard-advice orig-func args)
      (apply orig-func args)))

  (advice-add 'yank :around #'ig/markdown-paste-image-advice-helper)
